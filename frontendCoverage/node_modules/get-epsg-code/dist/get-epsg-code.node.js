...
var require_b64ab = __commonJS({
  "node_modules/b64ab/b64ab.js"(exports2, module2) {
    var b64ab2 = {};
    b64ab2.char2bits = {
      0: "110100",
      1: "110101",
    ...
    b64ab2.toArrayBuffer = function toArrayBuffer(b64) {
      var char2bits = b64ab2.char2bits;
      var eqct = 0;
    ...
    b64ab2.toBase64String = function toBase64String(ab) {
      if (!b64ab2.bits2char) {
        b64ab2.bits2char = {};
        for (let char in b64ab2.char2bits)
          b64ab2.bits2char[b64ab2.char2bits[char]] = char;
      }
      var bits2char = b64ab2.bits2char;
...
var require_index_of_match = __commonJS({
  "node_modules/xml-utils/index-of-match.js"(exports2, module2) {
...
var require_index_of_match_end = __commonJS({
  "node_modules/xml-utils/index-of-match-end.js"(exports2, module2) {
...
var require_count_substring = __commonJS({
  "node_modules/xml-utils/count-substring.js"(exports2, module2) {
...
var require_find_tag_by_name = __commonJS({
  "node_modules/xml-utils/find-tag-by-name.js"(exports2, module2) {
    ...
    function findTagByName2(xml, tagName, options) {
...
>/]`, startIndex);
    ...
    module2.exports = findTagByName2;
    module2.exports.default = findTagByName2;
  }
});

// node_modules/xml-utils/find-tags-by-name.js
var require_find_tags_by_name = __commonJS({
  "node_modules/xml-utils/find-tags-by-name.js"(exports2, module2) {
    var findTagByName2 = require_find_tag_by_name();
    ...
    module2.exports = findTagsByName;
    module2.exports.default = findTagsByName;
  }
});

// node_modules/xml-utils/find-tags-by-path.js
var require_find_tags_by_path = __commonJS({
  "node_modules/xml-utils/find-tags-by-path.js"(exports2, module2) {
    ...
    module2.exports = findTagsByPath;
    module2.exports.default = findTagsByPath;
  }
});

// node_modules/xml-utils/find-tag-by-path.js
var require_find_tag_by_path = __commonJS({
  "node_modules/xml-utils/find-tag-by-path.js"(exports2, module2) {
    var findTagsByPath = require_find_tags_by_path();
    function findTagByPath2(xml, path, options) {
      const debug = options && options.debug || false;
    ...
    module2.exports = findTagByPath2;
    module2.exports.default = findTagByPath2;
  }
});

// node_modules/xml-utils/get-attribute.js
var require_get_attribute = __commonJS({
  "node_modules/xml-utils/get-attribute.js"(exports2, module2) {
    ...
    module2.exports = getAttribute2;
    module2.exports.default = getAttribute2;
  }
});

// node_modules/wkt-parser/wkt.build.js
var require_wkt_build = __commonJS({
  "node_modules/wkt-parser/wkt.build.js"(exports2, module2) {
    "use strict";
    var NEUTRAL = 1;
    var KEYWORD = 2;
    var NUMBER = 3;
...
var require_getCodeFromEsriWKT = __commonJS({
  "node_modules/utm-utils/src/getCodeFromEsriWKT.js"(exports2, module2) {
    ...
    if (typeof module2 === "object") {
      module2.exports = getCodeFromEsriWKT;
      module2.exports.default = getCodeFromEsriWKT;
    }
  }
});
...
var require_getCodeFromProjString = __commonJS({
  "node_modules/utm-utils/src/getCodeFromProjString.js"(exports2, module2) {
    ...
    if (typeof module2 === "object") {
      module2.exports = getCodeFromProjString;
      module2.exports.default = getCodeFromProjString;
    }
  }
});
...
var require_hash = __commonJS({
  "lib/hash.js"(exports2, module2) {
    ...
    module2.exports = hash32;
    module2.exports.default = hash32;
  }
});

// node_modules/wkt-crs/wkt-crs.js
var require_wkt_crs = __commonJS({
  "node_modules/wkt-crs/wkt-crs.js"(exports2, module2) {
    function sort(data2, { keywords } = {}) {
      const keys = Object.keys(data2).filter((k) => !/\d+/.test(k));
      if (!keywords) {
        keywords = [];
        const counts = {};
    ...
    function parse(wkt, options) {
      ...
      function process(data3, parent) {
        const kw = data3[0];
        data3.forEach(function(it) {
          if (Array.isArray(it)) {
            process(it, data3);
          }
        });
        ...
        if (kwarr in parent) {
          parent[kwarr].push(data3);
        } else if (kw in parent) {
          parent[kwarr] = [parent[kw], data3];
          delete parent[kw];
        } else {
          parent[kw] = data3;
        }
      ...
      const result = process(data2, [data2]);
      if (debug)
...
var require_wkt = __commonJS({
  "lib/normalize/wkt.js"(exports2, module2) {
    var wktcrs = require_wkt_crs();
    function sort_wkt(wkt) {
      const { data: data2 } = wktcrs.parse(wkt, { raw: true });
      wktcrs.sort(data2);
      return wktcrs.unparse(data2, { raw: true }).data;
    }
    ...
    module2.exports = normalize_wkt;
    module2.exports.default = normalize_wkt;
  }
});

// lib/normalize/esriwkt.js
var require_esriwkt = __commonJS({
  "lib/normalize/esriwkt.js"(exports2, module2) {
    var normalize_wkt = require_wkt();
    function normalize_esriwkt2(esriwkt, { debug = false } = { debug: false }) {
      return normalize_wkt(esriwkt, { debug });
    }
    module2.exports = normalize_esriwkt2;
    module2.exports.default = normalize_esriwkt2;
  }
});

// lib/normalize/proj4.js
var require_proj4 = __commonJS({
  "lib/normalize/proj4.js"(exports2, module2) {
    function normalize_proj42(str, { debug = false, remove_k1 = true, remove_no_defs = true, remove_title = true, remove_init = true, remove_type = true } = {}) {
      str = str.trim();
      str = str.replace(/ +/g, " ");
    ...
    module2.exports = normalize_proj42;
    module2.exports.default = normalize_proj42;
  }
});

// node_modules/is-wkt/is-wkt.js
var require_is_wkt = __commonJS({
  "node_modules/is-wkt/is-wkt.js"(exports2, module2) {
    var keywords = [
      "PROJECTEDCRS",
      "PROJCRS",
      "GEOGCS",
    ...
    if (typeof module2 === "object") {
      module2.exports = isWKT;
      module2.exports.default = isWKT;
    }
    if (typeof self === "object")
      self.isWKT = isWKT;
    if (typeof window === "object")
...
var require_get_proj_type = __commonJS({
  "lib/get-proj-type.js"(exports2, module2) {
    var isWKT = require_is_wkt();
    var wktcrs = require_wkt_crs();
    var { FORMATS: FORMATS2 } = require_enums();
    var { ESRI_WKT: ESRI_WKT2, GEOSERVER: GEOSERVER2, MAPFILE: MAPFILE2, MAPNIK: MAPNIK2, OGC_GML: OGC_GML2, OGC_XML: OGC_XML2, OGC_WKT: OGC_WKT2, POSTGIS: POSTGIS2, PROJ_4: PROJ_42, PROJ_4_JS: PROJ_4_JS2, PROJJSON: PROJJSON2, WKT_2: WKT_22 } = FORMATS2;
    function getProjType2(input, { debug = false } = { debug: false }) {
    ...
    module2.exports = getProjType2;
    module2.exports.default = getProjType2;
  }
});

// lib/parse/proj4js.js
var require_proj4js = __commonJS({
  "lib/parse/proj4js.js"(exports2, module2) {
    function parseProj4JS2(input, { debug = false } = { debug: false }) {
    ...
    module2.exports = parseProj4JS2;
    module2.exports.default = parseProj4JS2;
  }
});

// lib/data/esriwkt-mapfile-proj4.json
var require_esriwkt_mapfile_proj4 = __commonJS({
  "lib/data/esriwkt-mapfile-proj4.json"(exports2, module2) {
    module2.exports = {
      properties: {
        columns: [
          "epsg_code",
...
var { ESRI_WKT, GEOSERVER, MAPFILE, MAPNIK, OGC_GML, OGC_XML, OGC_WKT, POSTGIS, PROJJSON, PROJ_4, PROJ_4_JS, WKT_2 } = FORMATS;
